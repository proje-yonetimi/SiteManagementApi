...
{
    public class ExpenseOpeningSlip
    {
        public int Id { get; set; }
        // Gider hesap. Account tablosunda Gider tipinde hesapla eşleşecek.
    ...
    public class ExpenseOpeningSlipEntityConfig : IEntityTypeConfiguration<ExpenseOpeningSlip>
    {
        public void Configure(EntityTypeBuilder<ExpenseOpeningSlip> builder)
        {
