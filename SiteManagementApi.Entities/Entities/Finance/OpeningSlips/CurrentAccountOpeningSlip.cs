...
{
    public class CurrentAccountOpeningSlip
    {
        public int Id { get; set; }
        // Cari hesap id'si. Account tablosunda Current tipinde hesap olacak.
    ...
    public class CurrentAccountOpeningSlipEntityConfig : IEntityTypeConfiguration<CurrentAccountOpeningSlip>
    {
        public void Configure(EntityTypeBuilder<CurrentAccountOpeningSlip> builder)
        {
