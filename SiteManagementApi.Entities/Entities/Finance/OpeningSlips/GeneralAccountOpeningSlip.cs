...
{
    public class GeneralAccountOpeningSlip
    {
        public int Id { get; set; }
        // Genel hesap. Account tablosunda genel tipinde hesapla eşleşecek.
    ...
    public class GeneralAccountOpeningSlipEntityConfig : IEntityTypeConfiguration<GeneralAccountOpeningSlip>
    {
        public void Configure(EntityTypeBuilder<GeneralAccountOpeningSlip> builder)
        {
